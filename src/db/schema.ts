...
export const subscriptionInsterSchema = createInsertSchema(subscriptions);
...
export const videos = pgTable("videos", {
  ...
  thumbnailKey: text("thumnail_key"),
  ...
  userId: uuid("user_id")
    .references(() => users.id, {
      onDelete: "cascade", // If the user is deleted, delete their videos
    })
    .notNull(),
  categoryId: uuid("category_id").references(() => categories.id, {
    onDelete: "set null", // If the category is deleted, set this to null
  }),
  createdAt: timestamp("created_at").notNull().defaultNow().notNull(),
  updatedAt: timestamp("updated_at").notNull().defaultNow().notNull(),
});
...
export const videoViewsInsterSchema = createInsertSchema(videoViews);
...
export const videoReactionsInsterSchema = createInsertSchema(videoReactions);
